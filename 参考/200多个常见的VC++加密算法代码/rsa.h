...
typedef RSAPrivateKeyTemplate<DecryptorTemplate<PKCS_EncryptionPaddingScheme, InvertableRSAFunction> >
...
typedef RSAPrivateKeyTemplate<DecryptorTemplate<OAEP<SHA>, InvertableRSAFunction> >
...
typedef RSAPrivateKeyTemplate<SignerTemplate<DigestSignerTemplate<PKCS_SignaturePaddingScheme, InvertableRSAFunction>, PKCS_DecoratedHashModule<SHA> > >
...
typedef RSAPrivateKeyTemplate<SignerTemplate<DigestSignerTemplate<PKCS_SignaturePaddingScheme, InvertableRSAFunction>, PKCS_DecoratedHashModule<MD2> > >
...
typedef RSAPrivateKeyTemplate<SignerTemplate<DigestSignerTemplate<PKCS_SignaturePaddingScheme, InvertableRSAFunction>, PKCS_DecoratedHashModule<MD5> > >
