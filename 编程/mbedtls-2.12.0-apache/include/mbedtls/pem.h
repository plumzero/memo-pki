...
typedef struct
{
    unsigned char *buf;     /*!< buffer for decoded data             */		//ASN.1编码内容的文件（如key,csr,crt等文件），此时已经对文件进行了base解码和解密，只剩下 ASN.1 解码了
    size_t buflen;          /*!< length of the buffer                */		//ASN.1编码文件的长度
