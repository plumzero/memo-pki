...
typedef struct
{
    ...
    mbedtls_mpi N;              /*!<  The public modulus. */		// N-模数 E和N的组合是公钥   密文 = 明文 ^ E mod N
    mbedtls_mpi E;              /*!<  The public exponent. */		// 公钥指数

    mbedtls_mpi D;              /*!<  The private exponent. */		//私钥指数 D和N的组合是私钥  明文 = 密文 ^ D mod N
